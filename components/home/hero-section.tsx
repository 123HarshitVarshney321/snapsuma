...
export default function HeroSection() {
    return (
        <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-20 lg:py-28 transition-all animate-in lg:px-12 max-w-7xl">
                ...
                <h2 className="text-lg sm:text-xl text-center lg:text-2xl px-4 lg:px-0 lg:max-w-4xl text-gray-600">Because reading 100 pages is so last century ✨</h2>
                <Button variant={'link'} className="text-white mt-6 text-base sm:text-lg lg:text-xl rounded-full px-8 sm:px-10 lg:px-12 py-6 sm:py-7 lg:py-8 lg:mt-16 bg-linear-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 hover:no-underline font-bold shadow-lg shadow-rose-500/50 transition-all duration-300">
                    <Link href="#pricing" className="flex gap-2 items-center">
                        <span>Try SnapSuma</span>
